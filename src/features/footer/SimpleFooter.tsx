...
export function SimpleFooter() {
  ...
  const whatsappUrl = `https://wa.me/${CONTACT_INFO.phoneRaw}?text=${encodeURIComponent(
  ...
  return (
      ...
      >
        {/* ✅ MÁS ESPACIO ARRIBA */}
        <div className="max-w-7xl mx-auto px-6 sm:px-8 pt-16 sm:pt-20 pb-12 sm:pb-16">
          {/* ✅ Mobile: más separación vertical */}
          <div className="flex flex-col sm:flex-row sm:flex-wrap items-start sm:justify-between gap-x-16 gap-y-14 sm:gap-y-12">
            {/* LOGO + TEXTO */}
            <div className="w-full sm:min-w-[320px] sm:max-w-[440px]">
              <br/>
              <div
            ...
            {/* ✅ SECCIONES: en mobile separadas por aire + línea suave (solo mobile) */}
            <div className="w-full sm:w-auto sm:min-w-[180px] pt-10 border-t border-slate-800/40 sm:pt-0 sm:border-0">
              <br/>
            ...
            {/* CONTACTO */}
            <div
                className="w-full sm:w-auto sm:min-w-[240px] sm:ml-auto text-left sm:text-right pt-10 border-t border-slate-800/40 sm:pt-0 sm:border-0">
              <br/>
              <h3 className="text-xs font-bold uppercase tracking-[0.28em] text-white mb-4">
                Contacto
              </h3>
              ...
              <div className="flex flex-col items-start sm:items-end space-y-3">
                <div className="relative">
                  ...
                  {emailCopied && (
                      <div
                          className="absolute -top-8 left-0 sm:left-auto sm:right-0 bg-green-600 text-white text-xs px-3 py-1 rounded-md shadow-lg animate-in fade-in slide-in-from-bottom-2 duration-200">
                        ¡Copiado!
                      </div>
                  )}
                </div>
          ...
          <div className="h-px w-full bg-slate-800/40 mt-10 sm:mt-12 mb-6 sm:mb-8" />
